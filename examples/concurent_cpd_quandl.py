...
def main(lookback_window_length: int):
    ...
    all_processes = [
        f'python -m examples.cpd_quandl "{ticker}" "{os.path.join(CPD_QUANDL_OUTPUT_FOLDER(lookback_window_length), ticker + ".csv")}" "2020-01-01" "2020-07-31" "{lookback_window_length}"'
